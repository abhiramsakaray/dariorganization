...
export default function GlobalSection() {
  // SEO: Structured data for Abhiram Sakaray (founder)
  const founderStructuredData = {
    "@context": "https://schema.org",
    "@type": "Person",
    "name": "Abhiram Sakaray",
    "jobTitle": "Founder & Visionary of DARI Organization",
    "description": "At just 18 years old, Abhiram Sakaray founded DARI with a bold vision to transform digital payments and stablecoin adoption globally. As the creator of a next-generation stablecoin wallet and payment ecosystem, he is pioneering secure, instant, and borderless transactions that bridge traditional banking with the future of decentralized finance.",
    "email": "abhiram@dariorganization.com",
    "url": "https://www.linkedin.com/in/abhiramsakaray/",
    "sameAs": [
      "https://www.linkedin.com/in/abhiramsakaray/",
      "https://twitter.com/abhiramsakaray",
      "https://instagram.com/abhiramsakaray"
    ]
  };
  return (
    <>
      {/* SEO: Structured data for founder */}
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(founderStructuredData) }} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="flex-1 space-y-4 font-sans">
            ...
            <div className="flex space-x-6 mt-4">
              <a href="mailto:abhiram@dariorganization.com" className="text-dari-green hover:text-green-700 text-2xl" aria-label="Email Abhiram Sakaray" rel="me">
              ...
              <a href="https://www.linkedin.com/in/abhiramsakaray/" target="_blank" rel="noopener noreferrer me" className="text-dari-green hover:text-green-700 text-2xl" aria-label="Abhiram Sakaray on LinkedIn">
              ...
              <a href="https://twitter.com/abhiramsakaray" target="_blank" rel="noopener noreferrer me" className="text-dari-green hover:text-green-700 text-2xl" aria-label="Abhiram Sakaray on Twitter">
              ...
              <a href="https://instagram.com/abhiramsakaray" target="_blank" rel="noopener noreferrer me" className="text-dari-green hover:text-green-700 text-2xl" aria-label="Abhiram Sakaray on Instagram">
